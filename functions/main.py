...
cred = credentials.Certificate("./custom-gpt-tutorial-firebase-adminsdk-y06s8-3ca4196581.json")
...
db_token = "p3JSXcD8HtMDkEPYUJaNu6stZxV5J7Bx" # you can generate it here https://www.random.org/passwords/?num=5&len=32&format=html&rnd=new
